...
class MC_inputs: 
  def __init__(self, esc_a, esc_b, esc_c, esc_d,ccycle_a , ccycle_b ,supp_lim, interiora , interiorb,interiorc,interiord,interiore,interiorf,ocean_a,ocean_b,Tstrat, surface_magma_frac,ThermoTemp):
    self.esc_a = esc_a
    self.esc_b = esc_b
    self.esc_c = esc_c
    self.esc_d = esc_d
...
class Model_outputs:
  def __init__(self, total_time,total_y,FH2O_array,FCO2_array,MH2O_liq,MH2O_crystal,MCO2_liq,Pressre_H2O,CO2_Pressure_array,fO2_array,Mass_O_atm,Mass_O_dissolved,water_frac,Ocean_depth,Max_depth,Ocean_fraction,TOA_shortwave): 
    ...
    self.TOA_shortwave = TOA_shortwave 
